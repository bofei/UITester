...
beforeEach(function(){
    ...
    var uiMatchers = {
        ...
        toHaveHtml: function(html) {
            var nodeList = $(this.actual);
            return (nodeList.item(0).html()) == (html);
        },
        // 检测html结构是否一致
        ...
        * */
        willAddChildren:function(selector,nodeNum){
            ...
            this.verify = jasmine.Matchers.matcherFn_('willAddChild',function(){
               ...
               console.log(this.actual,"add child",selector,"before",this.record,"after",after)
        ...
        willAddAttr:function(attrName,attrValue){
            ...
            this.verify = jasmine.Matchers.matcherFn_('willAddAttr',function(){
                    console.log(KISSY.DOM.get(this.actual), attrName,attrValue)
                return  KISSY.DOM.attr(KISSY.DOM.get(this.actual), attrName) ===attrValue;
            });
            return this;
        },
        willModifyAttr:function(attrName,newValue){
            ...
            // 记录下传入节点的子元素信息 innerHTML
            this.record = KISSY.DOM.attr(this.actual,attrName);
            // 验证节点子元素是否增加了selector所指定的节点. 个数是否一致

            this.verify = jasmine.Matchers.matcherFn_('willAddAttr',function(){
                return  KISSY.DOM.attr(this.actual, attrName)===newValue;
            });
            return this;
        },
        willRemoveAttr:function(attrName){
            ...
            this.verify = jasmine.Matchers.matcherFn_('willAddAttr',function(){
                return  this.record&& !KISSY.DOM.attr(this.actual,attrName);
            });
            return this;
        },
        willModifyInnerHTML:function(newValue){
            ...
            // 记录下传入节点的子元素信息 innerHTML
            this.record = KISSY.DOM.html(this.actual);
            // 验证节点子元素是否增加了selector所指定的节点. 个数是否一致

            this.verify = jasmine.Matchers.matcherFn_('willAddAttr',function(){
                return  KISSY.DOM.html(this.actual) ===newValue;
            });
            return this;
        }
